...
import { Bell, ChevronDown, Download, Search, Share2 } from "lucide-react";
...
const TITLE_MAP: { prefix: string; title: string }[] = [
  ...
  { prefix: "/follow-ups", title: "Notes" },
  { prefix: "/calendar", title: "Emails" },
  { prefix: "/agents", title: "Workflows" },
      ...
      <div className="flex flex-col gap-3 px-4 py-3 lg:flex-row lg:items-center lg:justify-between lg:px-6 lg:py-3.5">
        ...
        <div className="flex flex-wrap items-center gap-2 lg:flex-col lg:items-end xl:flex-row xl:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button variant="ghost" size="icon" className="h-9 w-9 shrink-0 text-muted-foreground" aria-label="Notifications">
